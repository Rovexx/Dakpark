 ...
 * @class       Flickr
 * @version     1.0
 * @author      Based on:  http://www.web-development-blog.com/archives/flickr-photo-search-api/
...
class Flickr
{
    ...
    /**
     * Get images based on a specific tag
     *
     * @param $tag
     * @return array
     */
    public function getImageUrls($tag)
    {
        $data = $this->search($tag);
        $images = [];
